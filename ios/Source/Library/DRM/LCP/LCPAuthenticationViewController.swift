...
class LCPAuthenticationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        case .passphraseNotFound:
            label.text = NSLocalizedString("lcp_passphraseNotFound_message", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Reason to ask for the passphrase when it was not found ")
        case .invalidPassphrase:
            label.text = NSLocalizedString("lcp_invalidPassphrase_message", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Reason to ask for the passphrase when the one entered was incorrect")
        ...
        promptLabel.text = NSLocalizedString("lcp_prompt_message1", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Prompt message when asking for the passphrase")
        messageLabel.text = String(format: NSLocalizedString("lcp_prompt_message2", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "More instructions about the passphrase"), provider)
    ...
    @IBAction func showSupportLink(_ sender: Any) {
        ...
        for (link, url) in supportLinks {
            let title: String = {
                ...
                if let scheme = url.scheme {
                    switch scheme {
                    case "http", "https":
                        return NSLocalizedString("lcp_support_website", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Contact the support through a website")
                    case "tel":
                        return NSLocalizedString("lcp_support_phone", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Contact the support by phone")
                    case "mailto":
                        return NSLocalizedString("lcp_support_mail", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Contact the support by mail")
                    default:
                        break
                    }
                }
                return NSLocalizedString("lcp_support_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Button to contact the support when entering the passphrase")
            }()
        ...
        alert.addAction(UIAlertAction(title: NSLocalizedString("cancel_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Cancel opening the LCP protected publication"), style: .cancel))
