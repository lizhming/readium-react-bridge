...
class LibraryViewController: UIViewController, Loggable {
    ...
    @IBOutlet weak var collectionView: UICollectionView! {
        didSet {
            ...
            collectionView.contentInset = UIEdgeInsets(top: 15, left: 20,
                                                       bottom: 20, right: 20)
            collectionView.register(UINib(nibName: "PublicationCollectionViewCell", bundle:  Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)),
    ...
    override func viewDidLoad() {
        ...
        collectionView.accessibilityLabel = NSLocalizedString("library_a11y_label", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Accessibility label for the library collection view")
    ...
    @objc func addBook() {
        let alert = UIAlertController(title: NSLocalizedString("library_add_book_title", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Title for the Add book alert"), message: nil, preferredStyle: .actionSheet)
        alert.addAction(UIAlertAction(title: NSLocalizedString("library_add_book_from_device_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "`Add a book from your device` button"), style: .default, handler: { _ in self.addBookFromDevice() }))
        alert.addAction(UIAlertAction(title: NSLocalizedString("library_add_book_from_url_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "`Add a book from a URL` button"), style: .default, handler: { _ in self.addBookFromURL() }))
        alert.addAction(UIAlertAction(title: NSLocalizedString("cancel_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Cancel adding a book from a URL"), style: .cancel))
    ...
    private func addBookFromURL(url: String? = nil, message: String? = nil) {
        let alert = UIAlertController(
            title: NSLocalizedString("library_add_book_from_url_title", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Title for the `Add book from URL` alert"),
            message: message,
            preferredStyle: .alert
        )
        
        func retry() {
            addBookFromURL(url: alert.textFields?[0].text, message: NSLocalizedString("library_add_book_from_url_failure_message", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Error message when trying to add a book from a URL"))
        }
        ...
        alert.addTextField { textField in
            textField.placeholder = NSLocalizedString("library_add_book_from_url_placeholder", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Placeholder for the URL field in the `Add book from URL` alert")
            textField.text = url
        }
        alert.addAction(UIAlertAction(title: NSLocalizedString("add_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Add a book from a URL button"), style: .default, handler: add))
        alert.addAction(UIAlertAction(title: NSLocalizedString("cancel_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Cancel adding a boom from a URL button"), style: .cancel))
...
extension LibraryViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        if downloadSet.count == 0 && books.count == 0 {
            ...
            noPublicationLabel.text = NSLocalizedString("library_empty_message", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Hint message when the library is empty")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.accessibilityHint = NSLocalizedString("library_publication_a11y_hint", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Accessibility hint for the publication collection cell")
...
extension LibraryViewController: PublicationCollectionViewCellDelegate {
    ...
    func removePublicationFromLibrary(forCellAt indexPath: IndexPath) {
        ...
        let removePublicationAlert = UIAlertController(
            title: NSLocalizedString("library_delete_alert_title", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Title of the publication remove confirmation alert"),
            message: NSLocalizedString("library_delete_alert_message", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Message of the publication remove confirmation alert"),
            preferredStyle: .alert
        )
        let removeAction = UIAlertAction(title: NSLocalizedString("remove_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Button to confirm the deletion of a publication"), style: .destructive, handler: { alert in
        ...
        let cancelAction = UIAlertAction(title: NSLocalizedString("cancel_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Button to cancel the deletion of a publication"), style: .cancel, handler: { alert in
            return
        })
...
extension LibraryViewController: DownloadDisplayDelegate {
    ...
    func didFinishDownload(task:URLSessionDownloadTask) {
        ...
        libraryDelegate?.presentAlert(
            NSLocalizedString("success_title", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Title of the alert when a publication is successfully downloaded"),
            message: String(format: NSLocalizedString("library_download_success_message", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Message of the alert when a publication is successfully downloaded"), description),
            from: self
        )
    ...
    func didFailWithError(task:URLSessionDownloadTask, error: Error?) {
        let offset = downloadSet.index(of: task)
        guard offset != Foundation.NSNotFound else {
            return
        }
    ...
    func insertNewItemWithUpdatedDataSource() {
        ...
        collectionView.performBatchUpdates({
            ...
            self.libraryDelegate?.presentAlert(
                NSLocalizedString("success_title", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Title of the alert when a publication is successfully imported"),
                message: NSLocalizedString("library_import_success_message", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Title of the alert when a publication is successfully imported"),
                from: self
            )
        })
    }
