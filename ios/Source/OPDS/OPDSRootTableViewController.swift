...
class OPDSRootTableViewController: UITableViewController {
        ...
        if let feed = parseData?.feed {
            ...
            if feed.facets.count > 0 {
                let filterButton = UIBarButtonItem(
                    title: NSLocalizedString("filter_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Filter the OPDS feed"),
            ...
            messageLabel.text = NSLocalizedString("opds_failure_message", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Error message when the feed couldn't be loaded")
            
            let editButton = UIButton(type: .system)
            editButton.frame = frame
            editButton.setTitle(NSLocalizedString("opds_edit_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Button to edit the OPDS catalog"), for: .normal)
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        ...
        case .MixedNavigationGroup:
            // Nav
            if section == 0 {
                title = NSLocalizedString("opds_browse_title", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Title of the section displaying the feeds")
            }
            // Groups
            if section >= 1 && section <= feed!.groups.count {
    ...
    override func tableView(_ tableView: UITableView, willDisplayHeaderView view: UIView, forSection section: Int) {
        ...
        header.textLabel?.accessibilityHint = NSLocalizedString("opds_feed_header_a11y_hint", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Accessibility hint feed section header")
        ...
        if let feed = feed {
            ...
            if offset >= 0 && offset < feed.groups.count {
                ...
                if links.count > 0 {
                    ...
                    moreButton.setTitle(NSLocalizedString("opds_more_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Button to expand a feed gallery"), for: .normal)
                    ...
                    moreButton.accessibilityLabel = NSLocalizedString("opds_more_button_a11y_label", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Button to expand a feed gallery")
