...
class OPDSPublicationTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        collectionView.register(UINib(nibName: "PublicationCollectionViewCell", bundle:  Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)), forCellWithReuseIdentifier: "publicationCollectionViewCell")
...
extension OPDSPublicationTableViewCell: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.accessibilityHint = NSLocalizedString("opds_show_detail_view_a11y_hint", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Accessibility hint for OPDS publication cell")
