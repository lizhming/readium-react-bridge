...
@objc(UserSettingsNavigationController)
class UserSettingsNavigationController: UINavigationController, UserSettingsDelegate,FontSelectionDelegate,AdvancedSettingsDelegate {
