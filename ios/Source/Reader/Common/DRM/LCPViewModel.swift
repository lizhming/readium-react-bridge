...
final class LCPViewModel: DRMViewModel {
    ...
    override var copiesLeft: String {
        ...
        return String(format: NSLocalizedString("lcp_characters_label", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Quantity of characters left to be copied"), quantity)
    }
    ...
    override var printsLeft: String {
        ...
        return String(format: NSLocalizedString("lcp_pages_label", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Quantity of pages left to be printed"), quantity)
    }
