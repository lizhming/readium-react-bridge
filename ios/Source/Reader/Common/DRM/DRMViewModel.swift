...
class DRMViewModel: NSObject {
    ...
    var copiesLeft: String {
        return NSLocalizedString("reader_drm_unlimited_label", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Unlimited quantity for a given DRM consumable right")
    }
