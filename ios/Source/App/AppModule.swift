...
final class AppModule {
    ...
    private(set) lazy var aboutViewController: UIViewController = {
        let storyboard = UIStoryboard(name: "App", bundle:  Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!))
...
extension AppModule: ModuleDelegate {
    ...
    func presentAlert(_ title: String, message: String, from viewController: UIViewController) {
        ...
        let dismissButton = UIAlertAction(title: NSLocalizedString("ok_button", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Alert button"), style: .cancel)
    ...
    func presentError(_ error: Error?, from viewController: UIViewController) {
        ...
        presentAlert(
            NSLocalizedString("error_title", bundle: Bundle(path: Bundle.main.path(forResource: "RNReadiumReactBridgeBundle", ofType: "bundle")!)!, comment: "Alert title for errors"),
